    ...
    fn update_info_prefers_github_release_metadata() {
        let release = TauriRelease {
            ...
            github: Some(GithubReleaseMetadata {
                ...
                html_url: Some("https://github.com/QYue64/dbx/releases/tag/v0.5.3".to_string()),
                body: Some("### 新功能\n\n真实发布说明".to_string()),
            }),
        };
        ...
        assert_eq!(info.release_url, "https://github.com/QYue64/dbx/releases/tag/v0.5.3");
