...
const PORTABLE_GITHUB_RELEASE_DOWNLOAD_PREFIX: &str =
    "https://gh-proxy.org/https://github.com/QYue64/dbx/releases/download/v";
...
pub fn portable_asset_download_url(version: &str) -> String {
    ...
    format!("{PORTABLE_GITHUB_RELEASE_DOWNLOAD_PREFIX}{version}/{}", portable_asset_filename(&version))
}
