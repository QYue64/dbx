...
export default withEnglishFallback({
  ...
  automationCenter: {
    ...
    importMerge: "合併",
    importReplace: "取代",
    fromCurrentSql: "從目前 SQL 建立",
    fromCurrentSqlShort: "目前 SQL",
    currentSqlJobName: "目前 SQL 自動化",
    templateTitle: "快速範本",
    templateHint: "先選任務類型，再補必要設定",
    useTemplate: "使用範本",
    empty: "尚無自動化任務",
    enabled: "已啟用",
    disabled: "已停用",
    ...
    table: "表",
    syncMode: "同步模式",
    syncExecutionMode: "同步執行方式",
    webDavConfig: "WebDAV 設定 JSON",
    webDavEndpoint: "WebDAV 位址",
    webDavUsername: "使用者名稱",
    webDavRemotePath: "遠端目錄",
    webDavPasswordPlaceholder: "輸入後可測試或儲存到系統安全儲存",
    webDavPasswordChecking: "正在檢查密碼",
    webDavPasswordSavedStatus: "密碼已儲存",
    webDavPasswordNotSaved: "密碼未儲存",
    testWebDav: "測試連線",
    saveWebDavPassword: "儲存密碼",
    forgetWebDavPassword: "忘記已儲存密碼",
    targetDir: "目標目錄",
    ...
    advancedConfig: "進階設定",
    bundleActions: "匯入 / 匯出",
    payloadJsonHint: "結構化表單會自動同步到這裡；僅在需要批次編輯或除錯時修改 JSON。",
    nextRun: "下次執行",
    lastRun: "最近執行",
    scheduleReadable: "排程說明",
    riskCheck: "風險檢查",
    executionOptions: "執行選項",
    timeoutSeconds: "逾時（秒）",
    retryCount: "重試次數",
    retryDelaySeconds: "重試間隔（秒）",
    notifyOn: "通知",
    attempts: "嘗試 {count} 次",
    syncStatements: "{count} 條同步 SQL",
    ready: "就緒",
    qualityNoFindings: "未發現明顯品質問題",
    dataCompareHint: "建議先預覽，確認產生 SQL 後再執行。",
    quickFix: "修復",
    copyRunDetails: "複製詳情",
    moreActions: "更多操作",
    save: "儲存",
    ...
    historySuccess: "成功",
    historyError: "失敗",
    clearCurrentHistory: "清理目前",
    clearAllHistory: "清理全部",
    qualityRows: "已分析 {count} 列",
    kind: {
      sql: "SQL",
      export: "匯出",
      sync: "同步",
    ...
    template: {
      "current-sql": {
        name: "執行目前 SQL",
        description: "讀取目前編輯器的 SQL、連線和資料庫，適合快速排程執行。",
      },
      "daily-export": {
        name: "每日匯出查詢結果",
        description: "每天固定時間把查詢結果匯出到本機檔案。",
      },
      "quality-check": {
        name: "品質檢查",
        description: "執行 SQL 後產生空值、重複值等品質摘要。",
      },
      "webdav-upload": {
        name: "WebDAV 上傳設定",
        description: "定時把目前設定上傳到 WebDAV 目錄。",
      },
      "saved-sql-directory": {
        name: "同步 SQL 庫目錄",
        description: "把 SQL 庫匯出到本機目錄，方便版本管理或備份。",
      },
      "data-compare-preview": {
        name: "資料同步預覽",
        description: "先產生同步 SQL 預覽，確認風險後再切換為執行。",
      },
    },
    scheduleSummary: {
      manual: "手動執行",
      interval: "每 {count} 分鐘執行",
      daily: "每天 {time} 執行",
      weekly: "每週 {days} 的 {time} 執行",
    ...
    syncModeOption: {
      "webdav-upload": "WebDAV 上傳",
      "webdav-download": "WebDAV 下載",
      "saved-sql-directory": "SQL 庫目錄",
      "data-compare": "資料庫資料同步",
    },
    ...
    reason: {
      connection_required: "缺少連線",
      connection_not_found: "連線不存在",
      source_connection_not_found: "來源連線不存在",
      target_connection_not_found: "目標連線不存在",
      sql_required: "缺少 SQL",
      path_required: "缺少路徑",
      sync_mode_required: "缺少同步模式",
      unsafe_sql: "危險 SQL",
      production_write_automation: "已阻擋生產寫入",
      export_mode_invalid: "匯出模式無效",
      format_invalid: "匯出格式不適用於目前模式",
      schedule_invalid: "排程設定無效",
      sync_execution_mode_invalid: "同步執行方式無效",
      table_required: "缺少表名",
      webdav_config_required: "缺少 WebDAV 設定",
      webdav_endpoint_required: "缺少 WebDAV 位址",
      target_required: "缺少目標",
      columns_required: "缺少欄位",
      key_columns_required: "缺少主鍵欄位",
    },
    reasonFix: {
      default: "檢查表單中對應的必填項或進階設定。",
      connection_required: "選擇一個連線。",
      connection_not_found: "重新選擇目前存在的連線。",
      source_connection_not_found: "為資料同步選擇有效的來源連線。",
      target_connection_not_found: "為資料同步選擇有效的目標連線。",
      sql_required: "填寫要執行的 SQL，或從目前 SQL 建立任務。",
      path_required: "選擇匯出檔案路徑。",
      sync_mode_required: "選擇一種同步模式。",
      unsafe_sql: "修改 SQL，或在治理策略中允許對應風險。",
      production_write_automation: "切換到預覽模式、選擇非生產連線，或調整治理策略。",
      export_mode_invalid: "重新選擇匯出模式。",
      format_invalid: "選擇目前匯出模式支援的格式。",
      schedule_invalid: "檢查間隔、時間、星期或每月日期。",
      sync_execution_mode_invalid: "選擇執行或僅預覽。",
      table_required: "填寫要匯出的表名。",
      webdav_config_required: "填寫 WebDAV 位址、使用者名稱和遠端目錄。",
      webdav_endpoint_required: "填寫 WebDAV 位址。",
      target_required: "選擇目標目錄。",
      columns_required: "填寫需要同步的欄位。",
      key_columns_required: "填寫用於匹配列的主鍵欄位。",
    },
    toast: {
      saved: "自動化已儲存",
      imported: "自動化已匯入",
      ...
      pathSelectFailed: "選擇路徑失敗：{message}",
      historyCleared: "執行歷史已清理",
      webdavTestSuccess: "WebDAV 連線測試成功",
      webdavTestFailed: "WebDAV 測試失敗：{message}",
      webdavPasswordRequired: "請輸入 WebDAV 密碼",
      webdavPasswordSaved: "WebDAV 密碼已儲存到系統安全儲存",
      webdavPasswordFailed: "儲存 WebDAV 密碼失敗：{message}",
      webdavPasswordForgotten: "已移除儲存的 WebDAV 密碼",
      copied: "已複製",
      fixPayload: "請先修正 Payload JSON",
      fixPlan: "請先修正風險檢查問題再啟用",
      fixRunPlan: "請先修正風險檢查問題再執行",
      runSuccess: "自動化執行完成",
      runSuccessNamed: "{name} 執行完成",
      runFailed: "{name} 執行失敗：{message}",
    },
    notify: {
      failure: "失敗時",
      always: "總是",
  ...
  updates: {
    ...
    failed: "檢查更新失敗：{error}",
    rateLimited: "GitHub 更新檢查暫時觸發頻率限制。請稍後重試自動更新，或開啟下載頁手動檢視。",
    openRelease: "開啟下載頁",
    retryAutoUpdate: "重試自動更新",
    downloadAndInstall: "自動更新",
    downloadPortableZip: "下載可攜版 ZIP",
    portableManualUpdate: "可攜版無法直接替換執行中的程式。DBX 會下載新版可攜 ZIP；下載完成後請關閉 DBX，並解壓縮覆蓋目前的 DBX 目錄，以保留 portable.dbx 和 data。",
    portableDownloadSaved: "可攜版 ZIP 已下載到：{path}",
    downloadingPortableZip: "正在下載可攜版 ZIP...",
  ...
  settings: {
    ...
    syncWebDavDescription: "透過 WebDAV 同步連線中繼資料、側邊欄、SQL 庫、桌面設定和編輯器偏好，方便多台裝置共用同一份 DBX 設定。",
    ...
    syncSecretNotice: "預設只同步非敏感設定。資料庫密碼、SSH 密碼、代理伺服器密碼、連線字串和 AI API Key 會保留在本機，除非啟用加密同步。",
    ...
    syncAutoUploadDescription: "僅在 DBX 開啟時執行。下載仍需手動確認，避免意外覆蓋本機連線、SQL 庫和介面偏好。",
    ...
    syncDownloadConfirm: "要下載並套用遠端 DBX 快照嗎？本機連線中繼資料、側邊欄、SQL 庫、桌面設定和編輯器偏好會被取代。",
    apply: "套用",
    applyAndClose: "套用並關閉",
    reset: "重設",
    resetDefaults: "還原預設",
  ...
  governanceCenter: {
    ...
    localRole: "本機角色",
    approveWrites: "寫入需審核",
    productionWrites: "允許正式環境寫入",
    dangerousSql: "允許危險 SQL",
    aiWrites: "允許 AI 寫入",
    aiDryRun: "AI 寫入需 dry-run",
    savePolicy: "儲存策略",
    activeConnectionAccess: "目前連線存取",
    noActiveConnection: "沒有目前連線",
    connectionAccessDescription: "選取此連線時，會在本機套用此預設角色。",
    saveAccess: "儲存存取",
    ...
    copyRollback: "複製回復",
    auditLog: "稽核記錄",
    noAuditRecords: "尚無稽核記錄",
    clearAudit: "清空稽核",
    pluginReadiness: "外掛發布就緒度",
    noPluginIssues: "沒有外掛發布問題",
    recentAuditRecords: "最近稽核記錄",
    auditEmptyHint: "SQL 執行完成後會顯示在這裡。",
    dataQualityFindings: "資料品質發現",
    qualityEmptyHint: "執行包含空值或重複值的查詢後會顯示發現。",
    automationDrafts: "自動化草稿",
    automationEmptyHint: "將目前 SQL 儲存為自動化草稿後可在這裡查看。",
    notConfigured: "未設定",
    noActiveSql: "沒有目前 SQL",
    rollbackRequired: "需要回復",
    noRollbackRequired: "不需要回復",
    healthy: "健康",
    pluginManifestsValid: "外掛清單有效",
    dryRun: "dry-run",
    direct: "直接執行",
    policyReady: "策略就緒",
    manualScheduleReady: "手動排程就緒",
    noResult: "沒有結果",
    runQueryToProfile: "執行查詢後可分析結果",
    qualityFinding: "空值 {nulls} ({rate}%) · 重複 {duplicates} · 唯一 {distinct}",
    section: {
      access: "存取",
      audit: "稽核",
      change: "變更",
    ...
    metric: {
      records: "{count} 筆記錄",
      checks: "{count} 項檢查",
      publishable: "{publishable}/{total} 可發布",
      drafts: "{count} 個草稿",
      rows: "{count} 列",
      nullRate: "{name}: {rate}% 空值",
      blocked: "{count} 個阻擋",
      pluginInstalled: "{publishable} 可發布 / {total} 已安裝",
    },
    reason: {
      connection_not_granted: "連線未授權",
      sql_policy_blocked: "SQL 被策略阻擋",
      dangerous_sql_requires_approval: "危險 SQL 需要審核",
      write_permission_required: "需要寫入權限",
      dangerous_sql_disabled: "危險 SQL 已停用",
      production_write_requires_approval: "正式環境寫入需要審核",
      workspace_write_approval_required: "工作區要求寫入審核",
      ai_auto_execute_disabled: "AI 自動執行已停用",
      ai_writes_disabled: "AI 寫入已停用",
      ai_write_dry_run_required: "AI 寫入需要 dry-run",
      connection_required: "需要連線",
      schedule_required: "需要排程",
      sql_required: "需要 SQL",
      target_required: "需要目標",
      unsafe_sql: "SQL 不安全",
      production_write_automation: "正式環境寫入自動化",
    },
    toast: {
      ...
      automationNoSql: "自動化草稿沒有可執行 SQL",
      migrationCopied: "遷移 SQL 已複製",
      rollbackCopied: "回復範本已複製",
      auditSqlCopied: "稽核 SQL 已複製",
      auditReportCopied: "稽核報告已複製",
      auditCleared: "稽核記錄已清空",
      diagnosticsCopied: "診斷報告已複製",
      runQueryBeforeQuality: "請先執行查詢再複製品質報告",
      qualityCopied: "品質報告已複製",
      pluginReportCopied: "外掛報告已複製",
      bundleCopied: "治理包已複製",
    },
  },
  databaseExport: {
