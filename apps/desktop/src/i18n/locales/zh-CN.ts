...
export default withEnglishFallback({
  ...
  automationCenter: {
    ...
    importMerge: "合并",
    importReplace: "替换",
    fromCurrentSql: "从当前 SQL 创建",
    fromCurrentSqlShort: "当前 SQL",
    currentSqlJobName: "当前 SQL 自动化",
    templateTitle: "快速模板",
    templateHint: "先选任务类型，再补必要配置",
    useTemplate: "使用模板",
    empty: "暂无自动化任务",
    enabled: "已启用",
    disabled: "已禁用",
    ...
    table: "表",
    syncMode: "同步模式",
    syncExecutionMode: "同步执行方式",
    webDavConfig: "WebDAV 配置 JSON",
    webDavEndpoint: "WebDAV 地址",
    webDavUsername: "用户名",
    webDavRemotePath: "远端目录",
    webDavPasswordPlaceholder: "输入后可测试或保存到系统安全存储",
    webDavPasswordChecking: "正在检查密码",
    webDavPasswordSavedStatus: "密码已保存",
    webDavPasswordNotSaved: "密码未保存",
    testWebDav: "测试连接",
    saveWebDavPassword: "保存密码",
    forgetWebDavPassword: "忘记已保存密码",
    targetDir: "目标目录",
    ...
    advancedConfig: "高级配置",
    bundleActions: "导入 / 导出",
    payloadJsonHint: "结构化表单会自动同步这里；仅在需要批量编辑或调试时修改 JSON。",
    nextRun: "下次运行",
    lastRun: "最近运行",
    scheduleReadable: "计划说明",
    riskCheck: "风险校验",
    ...
    notifyOn: "通知",
    attempts: "尝试 {count} 次",
    syncStatements: "{count} 条同步 SQL",
    ready: "就绪",
    qualityNoFindings: "未发现明显质量问题",
    dataCompareHint: "建议先预览，确认生成 SQL 后再执行。",
    quickFix: "修复",
    copyRunDetails: "复制详情",
    moreActions: "更多操作",
    save: "保存",
    ...
    historySuccess: "成功",
    historyError: "失败",
    clearCurrentHistory: "清理当前",
    clearAllHistory: "清理全部",
    qualityRows: "已分析 {count} 行",
    kind: {
      sql: "SQL",
      export: "导出",
      sync: "同步",
    ...
    template: {
      "current-sql": {
        name: "运行当前 SQL",
        description: "读取当前编辑器的 SQL、连接和数据库，适合快速定时执行。",
      },
      "daily-export": {
        name: "每日导出查询结果",
        description: "每天固定时间把查询结果导出到本地文件。",
      },
      "quality-check": {
        name: "质量检查",
        description: "执行 SQL 后生成空值、重复值等质量摘要。",
      },
      "webdav-upload": {
        name: "WebDAV 上传配置",
        description: "定时把当前配置上传到 WebDAV 目录。",
      },
      "saved-sql-directory": {
        name: "同步 SQL 库目录",
        description: "把 SQL 库导出到本地目录，方便版本管理或备份。",
      },
      "data-compare-preview": {
        name: "数据同步预览",
        description: "先生成同步 SQL 预览，确认风险后再切换为执行。",
      },
    },
    scheduleSummary: {
      manual: "手动运行",
      interval: "每 {count} 分钟运行",
      daily: "每天 {time} 运行",
      weekly: "每周 {days} 的 {time} 运行",
      monthly: "每月 {day} 日 {time} 运行",
    },
    exportModeOption: {
      query: "查询结果",
      table: "表数据",
    ...
    syncModeOption: {
      "webdav-upload": "WebDAV 上传",
      "webdav-download": "WebDAV 下载",
      "saved-sql-directory": "SQL 库目录",
      "data-compare": "数据库数据同步",
    },
    ...
    reason: {
      connection_required: "缺少连接",
      connection_not_found: "连接不存在",
      source_connection_not_found: "源连接不存在",
      target_connection_not_found: "目标连接不存在",
      sql_required: "缺少 SQL",
      path_required: "缺少路径",
      sync_mode_required: "缺少同步模式",
      unsafe_sql: "危险 SQL",
      production_write_automation: "生产写入已拦截",
      export_mode_invalid: "导出模式无效",
      format_invalid: "导出格式不适用于当前模式",
      schedule_invalid: "计划配置无效",
      sync_execution_mode_invalid: "同步执行方式无效",
      table_required: "缺少表名",
      webdav_config_required: "缺少 WebDAV 配置",
      webdav_endpoint_required: "缺少 WebDAV 地址",
      target_required: "缺少目标",
      columns_required: "缺少字段",
      key_columns_required: "缺少主键字段",
    },
    reasonFix: {
      default: "检查表单中对应的必填项或高级配置。",
      connection_required: "选择一个连接。",
      connection_not_found: "重新选择当前存在的连接。",
      source_connection_not_found: "为数据同步选择有效的源连接。",
      target_connection_not_found: "为数据同步选择有效的目标连接。",
      sql_required: "填写要执行的 SQL，或从当前 SQL 创建任务。",
      path_required: "选择导出文件路径。",
      sync_mode_required: "选择一种同步模式。",
      unsafe_sql: "修改 SQL，或在治理策略中允许对应风险。",
      production_write_automation: "切换到预览模式、选择非生产连接，或调整治理策略。",
      export_mode_invalid: "重新选择导出模式。",
      format_invalid: "选择当前导出模式支持的格式。",
      schedule_invalid: "检查间隔、时间、星期或每月日期。",
      sync_execution_mode_invalid: "选择执行或仅预览。",
      table_required: "填写要导出的表名。",
      webdav_config_required: "填写 WebDAV 地址、用户名和远端目录。",
      webdav_endpoint_required: "填写 WebDAV 地址。",
      target_required: "选择目标目录。",
      columns_required: "填写需要同步的字段。",
      key_columns_required: "填写用于匹配行的主键字段。",
    },
    toast: {
      saved: "自动化已保存",
      imported: "自动化已导入",
      ...
      pathSelectFailed: "选择路径失败：{message}",
      historyCleared: "运行历史已清理",
      webdavTestSuccess: "WebDAV 连接测试成功",
      webdavTestFailed: "WebDAV 测试失败：{message}",
      webdavPasswordRequired: "请输入 WebDAV 密码",
      webdavPasswordSaved: "WebDAV 密码已保存到系统安全存储",
      webdavPasswordFailed: "保存 WebDAV 密码失败：{message}",
      webdavPasswordForgotten: "已移除保存的 WebDAV 密码",
      copied: "已复制",
      fixPayload: "请先修正 Payload JSON",
      fixPlan: "请先修正风险校验问题再启用",
      fixRunPlan: "请先修正风险校验问题再运行",
      runSuccess: "自动化运行完成",
      runSuccessNamed: "{name} 运行完成",
      runFailed: "{name} 运行失败：{message}",
    },
    notify: {
      failure: "失败时",
      always: "总是",
  ...
  updates: {
    ...
    failed: "检查更新失败：{error}",
    rateLimited: "GitHub 更新检查暂时触发频率限制。请稍后重试自动更新，或打开下载页手动查看。",
    openRelease: "打开下载页",
    retryAutoUpdate: "重试自动更新",
    downloadAndInstall: "自动更新",
    downloadPortableZip: "下载便携版 ZIP",
    portableManualUpdate: "便携版不能使用应用内安装器直接替换程序。DBX 会下载新版便携 ZIP；下载完成后请关闭 DBX，并解压覆盖当前 DBX 目录，以保留 portable.dbx 和 data。",
    portableDownloadSaved: "便携版 ZIP 已下载到：{path}",
    downloadingPortableZip: "正在下载便携版 ZIP...",
  ...
  settings: {
    ...
    syncWebDavDescription: "通过 WebDAV 同步连接元信息、侧边栏、SQL 库、桌面设置和编辑器偏好，便于多台设备共用同一份 DBX 配置。",
    ...
    syncSecretNotice: "默认只同步非敏感配置。数据库密码、SSH 密码、代理密码、连接串和 AI API Key 会保留在本机，除非开启加密同步。",
    ...
    syncAutoUploadDescription: "仅在 DBX 打开时运行。下载仍需手动确认，避免意外覆盖本机连接、SQL 库和界面偏好。",
    ...
    syncDownloadConfirm: "要下载并应用远端 DBX 快照吗？本机连接元信息、侧边栏、SQL 库、桌面设置和编辑器偏好会被替换。",
    apply: "应用",
    applyAndClose: "应用并关闭",
    reset: "重置",
    resetDefaults: "恢复默认",
  ...
  governanceCenter: {
    ...
    localRole: "本地角色",
    approveWrites: "写入需审批",
    productionWrites: "允许生产写入",
    dangerousSql: "允许危险 SQL",
    aiWrites: "允许 AI 写入",
    aiDryRun: "AI 写入需 dry-run",
    savePolicy: "保存策略",
    activeConnectionAccess: "当前连接访问",
    noActiveConnection: "暂无当前连接",
    connectionAccessDescription: "当前连接被选中时，将在本地应用此默认角色。",
    saveAccess: "保存访问",
    ...
    clearAudit: "清空审计",
    pluginReadiness: "插件发布就绪度",
    noPluginIssues: "暂无插件发布问题",
    recentAuditRecords: "最近审计记录",
    auditEmptyHint: "SQL 执行完成后会显示在这里。",
    dataQualityFindings: "数据质量发现",
    qualityEmptyHint: "执行包含空值或重复值的查询后会显示发现。",
    automationDrafts: "自动化草稿",
    automationEmptyHint: "将当前 SQL 保存为自动化草稿后可在这里查看。",
    notConfigured: "未配置",
    noActiveSql: "暂无当前 SQL",
    rollbackRequired: "需要回滚",
    noRollbackRequired: "无需回滚",
    healthy: "健康",
    pluginManifestsValid: "插件清单有效",
    dryRun: "dry-run",
    direct: "直接执行",
    policyReady: "策略就绪",
    manualScheduleReady: "手动计划就绪",
    noResult: "暂无结果",
    runQueryToProfile: "执行查询后可分析结果",
    qualityFinding: "空值 {nulls} ({rate}%) · 重复 {duplicates} · 唯一 {distinct}",
    section: {
      access: "访问",
      audit: "审计",
      change: "变更",
    ...
    metric: {
      records: "{count} 条记录",
      checks: "{count} 项检查",
      publishable: "{publishable}/{total} 可发布",
      drafts: "{count} 个草稿",
      rows: "{count} 行",
      nullRate: "{name}: {rate}% 空值",
      blocked: "{count} 个阻断",
      pluginInstalled: "{publishable} 可发布 / {total} 已安装",
    },
    reason: {
      connection_not_granted: "连接未授权",
      sql_policy_blocked: "SQL 被策略阻断",
      dangerous_sql_requires_approval: "危险 SQL 需要审批",
      write_permission_required: "需要写入权限",
      dangerous_sql_disabled: "危险 SQL 已禁用",
      production_write_requires_approval: "生产写入需要审批",
      workspace_write_approval_required: "工作区要求写入审批",
      ai_auto_execute_disabled: "AI 自动执行已禁用",
      ai_writes_disabled: "AI 写入已禁用",
      ai_write_dry_run_required: "AI 写入需要 dry-run",
      connection_required: "需要连接",
      schedule_required: "需要计划",
      sql_required: "需要 SQL",
      target_required: "需要目标",
      unsafe_sql: "SQL 不安全",
      production_write_automation: "生产写入自动化",
    },
    toast: {
      ...
      automationNoSql: "自动化草稿没有可执行 SQL",
      migrationCopied: "迁移 SQL 已复制",
      rollbackCopied: "回滚模板已复制",
      auditSqlCopied: "审计 SQL 已复制",
      auditReportCopied: "审计报告已复制",
      auditCleared: "审计记录已清空",
      diagnosticsCopied: "诊断报告已复制",
      runQueryBeforeQuality: "请先执行查询再复制质量报告",
      qualityCopied: "质量报告已复制",
      pluginReportCopied: "插件报告已复制",
      bundleCopied: "治理包已复制",
    },
  },
  databaseExport: {
