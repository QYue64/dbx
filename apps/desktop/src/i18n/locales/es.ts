...
export default withEnglishFallback({
  ...
  automationCenter: {
    ...
    webDavPasswordPlaceholder: "Ingresa para probar o guardar en almacenamiento seguro",
    webDavPasswordChecking: "Comprobando contraseña",
    webDavPasswordSavedStatus: "Contraseña guardada",
    webDavPasswordNotSaved: "Contraseña no guardada",
    testWebDav: "Probar conexión",
    saveWebDavPassword: "Guardar contraseña",
    forgetWebDavPassword: "Olvidar contraseña guardada",
    bundleActions: "Importar / exportar",
    running: "Ejecutando",
    dataCompareHint: "Previsualiza primero; ejecuta después de revisar el SQL generado.",
    quickFix: "Corregir",
    copyRunDetails: "Copiar detalles",
    moreActions: "Más acciones",
    historyAll: "Todo",
    historySuccess: "Correcto",
    historyError: "Error",
    clearCurrentHistory: "Limpiar actual",
    clearAllHistory: "Limpiar todo",
    syncExecutionMode: "Ejecución de sincronización",
    syncExecutionModeOption: {
      execute: "Ejecutar SQL de sincronización",
      preview: "Solo vista previa",
    },
    toast: {
      imported: "Automatización importada",
      exported: "Automatización exportada",
      importFailed: "Error al importar: {message}",
      exportFailed: "Error al exportar: {message}",
      pathSelectFailed: "Error al elegir ruta: {message}",
      historyCleared: "Historial de ejecución borrado",
      webdavTestSuccess: "Prueba WebDAV correcta",
      webdavTestFailed: "Error en prueba WebDAV: {message}",
      webdavPasswordRequired: "Ingresa primero una contraseña WebDAV",
      webdavPasswordSaved: "Contraseña WebDAV guardada en almacenamiento seguro",
      webdavPasswordFailed: "Error al guardar contraseña WebDAV: {message}",
      webdavPasswordForgotten: "Contraseña WebDAV guardada eliminada",
      copied: "Copiado",
    },
  },
  updates: {
    ...
    rateLimited: "Las verificaciones de actualizaciones de GitHub están temporalmente limitadas. Reintenta la actualización automática más tarde o abre la página de lanzamientos.",
    openRelease: "Abrir lanzamiento",
    retryAutoUpdate: "Reintentar actualización automática",
    downloadAndInstall: "Actualizar automáticamente",
    downloadPortableZip: "Descargar ZIP portable",
    portableManualUpdate: "Las versiones portables no pueden reemplazar la app en ejecución. DBX descargará el nuevo ZIP portable; al finalizar, cierra DBX y extráelo sobre la carpeta actual para conservar portable.dbx y data.",
    portableDownloadSaved: "ZIP portable descargado en: {path}",
    downloadingPortableZip: "Descargando ZIP portable...",
  ...
  settings: {
    ...
    syncWebDavDescription: "Sincroniza metadatos de conexión, barra lateral, SQL guardado, ajustes de escritorio y preferencias del editor entre dispositivos mediante WebDAV.",
    ...
    syncSecretNotice: "De forma predeterminada, DBX solo sincroniza configuración no sensible. Las contraseñas de base de datos, SSH, proxy, cadenas de conexión y API keys de IA quedan locales salvo que actives la sincronización cifrada.",
    ...
    syncAutoUploadDescription: "Se ejecuta mientras DBX está abierto. Las descargas aún requieren confirmación manual para evitar reemplazar conexiones, SQL guardado y preferencias de interfaz locales.",
    ...
    syncDownloadConfirm: "¿Descargar y aplicar la instantánea remota de DBX? Se reemplazarán metadatos de conexión, barra lateral, SQL guardado, ajustes de escritorio y preferencias del editor locales.",
    apply: "Aplicar",
  ...
  governanceCenter: {
    ...
    localRole: "Rol local",
    approveWrites: "Aprobar escrituras",
    productionWrites: "Escrituras en producción",
    dangerousSql: "SQL peligroso",
    aiWrites: "Escrituras de IA",
    aiDryRun: "Dry-run de IA",
    savePolicy: "Guardar política",
    activeConnectionAccess: "Acceso de conexión activa",
    noActiveConnection: "Sin conexión activa",
    connectionAccessDescription: "El rol predeterminado se aplica localmente al seleccionar esta conexión.",
    saveAccess: "Guardar acceso",
    saveAutomation: "Guardar automatización",
    copyDiagnostics: "Copiar diagnóstico",
    copyQuality: "Copiar calidad",
    copyBundle: "Copiar paquete",
    copyAudit: "Copiar auditoría",
    copyPlugins: "Copiar plugins",
    changeArtifact: "Artefacto de cambio",
    approval: "aprobación",
    ready: "listo",
    copyMigration: "Copiar migración",
    copyRollback: "Copiar rollback",
    auditLog: "Registro de auditoría",
    noAuditRecords: "Aún no hay registros de auditoría",
    clearAudit: "Limpiar auditoría",
    pluginReadiness: "Preparación de plugins",
    noPluginIssues: "No hay problemas de publicación de plugins",
    recentAuditRecords: "Registros de auditoría recientes",
    auditEmptyHint: "El SQL ejecutado aparecerá aquí al finalizar una consulta.",
    dataQualityFindings: "Hallazgos de calidad de datos",
    qualityEmptyHint: "Ejecuta una consulta con valores nulos o duplicados para ver hallazgos.",
    automationDrafts: "Borradores de automatización",
    automationEmptyHint: "Guarda el SQL activo como borrador de automatización para revisarlo aquí.",
    notConfigured: "no configurado",
    noActiveSql: "sin SQL activo",
    rollbackRequired: "rollback requerido",
    noRollbackRequired: "rollback no requerido",
    healthy: "saludable",
    pluginManifestsValid: "manifiestos de plugins válidos",
    dryRun: "dry-run",
    direct: "directo",
    policyReady: "política lista",
    manualScheduleReady: "programación manual lista",
    noResult: "sin resultado",
    runQueryToProfile: "ejecuta una consulta para perfilar resultados",
    qualityFinding: "nulos {nulls} ({rate}%) · duplicados {duplicates} · distintos {distinct}",
    section: {
      access: "Acceso",
      audit: "Auditoría",
      change: "Cambio",
    ...
    metric: {
      ...
      publishable: "{publishable}/{total} publicables",
      drafts: "{count} borradores",
      rows: "{count} filas",
      nullRate: "{name}: {rate}% nulos",
      blocked: "{count} bloqueados",
      pluginInstalled: "{publishable} publicables / {total} instalados",
    },
    reason: {
      connection_not_granted: "conexión no autorizada",
      sql_policy_blocked: "SQL bloqueado por política",
      dangerous_sql_requires_approval: "SQL peligroso requiere aprobación",
      write_permission_required: "se requiere permiso de escritura",
      dangerous_sql_disabled: "SQL peligroso deshabilitado",
      production_write_requires_approval: "la escritura en producción requiere aprobación",
      workspace_write_approval_required: "el espacio de trabajo requiere aprobación de escritura",
      ai_auto_execute_disabled: "ejecución automática de IA deshabilitada",
      ai_writes_disabled: "escrituras de IA deshabilitadas",
      ai_write_dry_run_required: "la escritura de IA requiere dry-run",
      connection_required: "conexión requerida",
      schedule_required: "programación requerida",
      sql_required: "SQL requerido",
      target_required: "destino requerido",
      unsafe_sql: "SQL inseguro",
      production_write_automation: "automatización de escritura en producción",
    },
    toast: {
      ...
      automationNoSql: "El borrador no tiene SQL ejecutable",
      migrationCopied: "SQL de migración copiado",
      rollbackCopied: "Plantilla de rollback copiada",
      auditSqlCopied: "SQL de auditoría copiado",
      auditReportCopied: "Informe de auditoría copiado",
      auditCleared: "Registros de auditoría limpiados",
      diagnosticsCopied: "Diagnóstico copiado",
      runQueryBeforeQuality: "Ejecuta una consulta antes de copiar el informe de calidad",
      qualityCopied: "Informe de calidad copiado",
      pluginReportCopied: "Informe de plugins copiado",
      bundleCopied: "Paquete de gobernanza copiado",
    },
  },
  databaseExport: {
