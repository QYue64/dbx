...
export default withEnglishFallback({
  ...
  automationCenter: {
    ...
    choosePath: "Scegli percorso",
    webDavPasswordPlaceholder: "Inserisci per testare o salvare nello storage sicuro",
    webDavPasswordChecking: "Controllo password",
    webDavPasswordSavedStatus: "Password salvata",
    webDavPasswordNotSaved: "Password non salvata",
    testWebDav: "Test connessione",
    saveWebDavPassword: "Salva password",
    forgetWebDavPassword: "Dimentica password salvata",
    bundleActions: "Importa / esporta",
    running: "In esecuzione",
    dataCompareHint: "Prima visualizza l'anteprima; esegui dopo aver rivisto l'SQL generato.",
    quickFix: "Correggi",
    copyRunDetails: "Copia dettagli",
    moreActions: "Altre azioni",
    historyAll: "Tutti",
    historySuccess: "Successo",
    historyError: "Errore",
    clearCurrentHistory: "Pulisci attuale",
    clearAllHistory: "Pulisci tutto",
    syncExecutionMode: "Esecuzione sincronizzazione",
    syncExecutionModeOption: {
      execute: "Esegui SQL di sincronizzazione",
      preview: "Solo anteprima",
    },
    toast: {
      imported: "Automazione importata",
      exported: "Automazione esportata",
      importFailed: "Importazione non riuscita: {message}",
      exportFailed: "Esportazione non riuscita: {message}",
      pathSelectFailed: "Selezione percorso non riuscita: {message}",
      historyCleared: "Cronologia esecuzioni pulita",
      webdavTestSuccess: "Test WebDAV riuscito",
      webdavTestFailed: "Test WebDAV non riuscito: {message}",
      webdavPasswordRequired: "Inserisci prima una password WebDAV",
      webdavPasswordSaved: "Password WebDAV salvata nello storage sicuro",
      webdavPasswordFailed: "Salvataggio password WebDAV non riuscito: {message}",
      webdavPasswordForgotten: "Password WebDAV salvata rimossa",
      copied: "Copiato",
    },
  },
  updates: {
    ...
    rateLimited: "Le verifiche degli aggiornamenti di GitHub sono temporaneamente limitate. Riprova l'aggiornamento automatico più tardi o apri la pagina delle release.",
    openRelease: "Apri Release",
    retryAutoUpdate: "Riprova aggiornamento automatico",
    downloadAndInstall: "Aggiornamento automatico",
    downloadPortableZip: "Scarica ZIP portatile",
    portableManualUpdate: "Le build portatili non possono sostituire l'app in esecuzione. DBX scaricherà il nuovo ZIP portatile; al termine, chiudi DBX ed estrailo nella cartella corrente per mantenere portable.dbx e i dati.",
    portableDownloadSaved: "ZIP portatile scaricato in: {path}",
    downloadingPortableZip: "Download ZIP portatile...",
  ...
  connection: {
    ...
    testSuccessTitle: "Test connessione riuscito",
    testFailedTitle: "Test connessione non riuscito",
  ...
  settings: {
    ...
    syncWebDavDescription: "Sincronizza metadati di connessione, barra laterale, SQL salvati, impostazioni desktop e preferenze dell'editor tra dispositivi tramite WebDAV.",
    ...
    syncSecretNotice: "Per impostazione predefinita, DBX sincronizza solo configurazioni non sensibili. Password database, password SSH, password proxy, stringhe di connessione e chiavi API AI restano locali salvo attivare la sincronizzazione crittografata.",
    ...
    syncAutoUploadDescription: "Viene eseguito mentre DBX è aperto. I download richiedono ancora conferma manuale per evitare di sostituire connessioni, SQL salvati e preferenze UI locali.",
    ...
    syncDownloadConfirm: "Scaricare e applicare lo snapshot DBX remoto? Metadati di connessione, barra laterale, SQL salvati, impostazioni desktop e preferenze dell'editor locali verranno sostituiti.",
    apply: "Applica",
  ...
  governanceCenter: {
    title: "Centro governance",
    localRole: "Ruolo locale",
    approveWrites: "Approva scritture",
    productionWrites: "Scritture in produzione",
    dangerousSql: "SQL pericoloso",
    aiWrites: "Scritture AI",
    aiDryRun: "Dry-run AI",
    savePolicy: "Salva policy",
    activeConnectionAccess: "Accesso connessione attiva",
    noActiveConnection: "Nessuna connessione attiva",
    connectionAccessDescription: "Il ruolo predefinito viene applicato localmente quando questa connessione è selezionata.",
    saveAccess: "Salva accesso",
    saveAutomation: "Salva automazione",
    copyDiagnostics: "Copia diagnostica",
    copyQuality: "Copia qualità",
    copyBundle: "Copia pacchetto",
    copyAudit: "Copia audit",
    copyPlugins: "Copia plugin",
    changeArtifact: "Artefatto modifica",
    approval: "approvazione",
    ready: "pronto",
    copyMigration: "Copia migrazione",
    copyRollback: "Copia rollback",
    auditLog: "Log audit",
    noAuditRecords: "Nessun record audit",
    clearAudit: "Cancella audit",
    pluginReadiness: "Prontezza plugin",
    noPluginIssues: "Nessun problema di pubblicazione plugin",
    recentAuditRecords: "Record audit recenti",
    auditEmptyHint: "Il SQL eseguito apparirà qui al termine della query.",
    dataQualityFindings: "Risultati qualità dati",
    qualityEmptyHint: "Esegui una query con valori nulli o duplicati per vedere i risultati.",
    automationDrafts: "Bozze automazione",
    automationEmptyHint: "Salva il SQL attivo come bozza automazione per rivederlo qui.",
    notConfigured: "non configurato",
    noActiveSql: "nessun SQL attivo",
    rollbackRequired: "rollback richiesto",
    noRollbackRequired: "rollback non richiesto",
    healthy: "sano",
    pluginManifestsValid: "manifest plugin validi",
    dryRun: "dry-run",
    direct: "diretto",
    policyReady: "policy pronta",
    manualScheduleReady: "pianificazione manuale pronta",
    noResult: "nessun risultato",
    runQueryToProfile: "esegui una query per profilare i risultati",
    qualityFinding: "null {nulls} ({rate}%) · duplicati {duplicates} · distinti {distinct}",
    section: {
      access: "Accesso",
      audit: "Audit",
      change: "Modifica",
    ...
    metric: {
      ...
      checks: "{count} controlli",
      publishable: "{publishable}/{total} pubblicabili",
      drafts: "{count} bozze",
      rows: "{count} righe",
      nullRate: "{name}: {rate}% null",
      blocked: "{count} bloccati",
      pluginInstalled: "{publishable} pubblicabili / {total} installati",
    },
    reason: {
      connection_not_granted: "connessione non autorizzata",
      sql_policy_blocked: "SQL bloccato dalla policy",
      dangerous_sql_requires_approval: "SQL pericoloso richiede approvazione",
      write_permission_required: "permesso di scrittura richiesto",
      dangerous_sql_disabled: "SQL pericoloso disabilitato",
      production_write_requires_approval: "scrittura in produzione richiede approvazione",
      workspace_write_approval_required: "lo spazio di lavoro richiede approvazione scrittura",
      ai_auto_execute_disabled: "esecuzione automatica AI disabilitata",
      ai_writes_disabled: "scritture AI disabilitate",
      ai_write_dry_run_required: "scrittura AI richiede dry-run",
      connection_required: "connessione richiesta",
      schedule_required: "pianificazione richiesta",
      sql_required: "SQL richiesto",
      target_required: "destinazione richiesta",
      unsafe_sql: "SQL non sicuro",
      production_write_automation: "automazione scrittura in produzione",
    },
    toast: {
      ...
      automationNoSql: "La bozza non ha SQL eseguibile",
      migrationCopied: "SQL migrazione copiato",
      rollbackCopied: "Template rollback copiato",
      auditSqlCopied: "SQL audit copiato",
      auditReportCopied: "Report audit copiato",
      auditCleared: "Record audit cancellati",
      diagnosticsCopied: "Diagnostica copiata",
      runQueryBeforeQuality: "Esegui una query prima di copiare il report qualità",
      qualityCopied: "Report qualità copiato",
      pluginReportCopied: "Report plugin copiato",
      bundleCopied: "Pacchetto governance copiato",
    },
  },
  databaseExport: {
