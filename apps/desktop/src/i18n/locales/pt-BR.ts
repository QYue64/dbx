...
export default withEnglishFallback({
  ...
  automationCenter: {
    ...
    choosePath: "Escolher caminho",
    webDavPasswordPlaceholder: "Digite para testar ou salvar no armazenamento seguro",
    webDavPasswordChecking: "Verificando senha",
    webDavPasswordSavedStatus: "Senha salva",
    webDavPasswordNotSaved: "Senha não salva",
    testWebDav: "Testar conexão",
    saveWebDavPassword: "Salvar senha",
    forgetWebDavPassword: "Esquecer senha salva",
    bundleActions: "Importar / exportar",
    running: "Executando",
    dataCompareHint: "Pré-visualize primeiro; execute após revisar o SQL gerado.",
    quickFix: "Corrigir",
    copyRunDetails: "Copiar detalhes",
    moreActions: "Mais ações",
    historyAll: "Tudo",
    historySuccess: "Sucesso",
    historyError: "Erro",
    clearCurrentHistory: "Limpar atual",
    clearAllHistory: "Limpar tudo",
    syncExecutionMode: "Execução da sincronização",
    syncExecutionModeOption: {
      execute: "Executar SQL de sincronização",
      preview: "Somente prévia",
    },
    toast: {
      imported: "Automação importada",
      exported: "Automação exportada",
      importFailed: "Falha ao importar: {message}",
      exportFailed: "Falha ao exportar: {message}",
      pathSelectFailed: "Falha ao selecionar caminho: {message}",
      historyCleared: "Histórico de execução limpo",
      webdavTestSuccess: "Teste WebDAV concluído com sucesso",
      webdavTestFailed: "Falha no teste WebDAV: {message}",
      webdavPasswordRequired: "Digite uma senha WebDAV primeiro",
      webdavPasswordSaved: "Senha WebDAV salva no armazenamento seguro",
      webdavPasswordFailed: "Falha ao salvar senha WebDAV: {message}",
      webdavPasswordForgotten: "Senha WebDAV salva removida",
      copied: "Copiado",
    },
  },
  updates: {
    ...
    rateLimited: "As verificações de atualização do GitHub estão temporariamente limitadas. Tente a atualização automática novamente mais tarde ou abra a página de lançamento.",
    openRelease: "Abrir Lançamento",
    retryAutoUpdate: "Tentar atualização automática novamente",
    downloadAndInstall: "Atualização automática",
    downloadPortableZip: "Baixar ZIP portátil",
    portableManualUpdate: "Versões portáteis não podem substituir o app em execução. O DBX baixará o novo ZIP portátil; ao terminar, feche o DBX e extraia-o sobre a pasta atual para manter portable.dbx e os dados.",
    portableDownloadSaved: "ZIP portátil baixado em: {path}",
    downloadingPortableZip: "Baixando ZIP portátil...",
  ...
  settings: {
    ...
    syncWebDavDescription: "Sincronize metadados de conexão, barra lateral, SQL salvo, configurações do desktop e preferências do editor entre dispositivos via WebDAV.",
    ...
    syncSecretNotice: "Por padrão, o DBX sincroniza apenas configurações não sensíveis. Senhas de banco de dados, senhas SSH, senhas de proxy, strings de conexão e chaves de API de IA permanecem locais, a menos que a sincronização criptografada seja ativada.",
    ...
    syncAutoUploadDescription: "Executa enquanto o DBX está aberto. Downloads ainda exigem confirmação manual para evitar substituir conexões, SQL salvo e preferências de interface locais.",
    ...
    syncDownloadConfirm: "Baixar e aplicar o snapshot remoto do DBX? Metadados de conexão, barra lateral, SQL salvo, configurações do desktop e preferências do editor locais serão substituídos.",
    apply: "Aplicar",
  ...
  governanceCenter: {
    ...
    localRole: "Função local",
    approveWrites: "Aprovar escritas",
    productionWrites: "Escritas em produção",
    dangerousSql: "SQL perigoso",
    aiWrites: "Escritas por IA",
    aiDryRun: "Dry-run de IA",
    savePolicy: "Salvar política",
    activeConnectionAccess: "Acesso da conexão ativa",
    noActiveConnection: "Nenhuma conexão ativa",
    connectionAccessDescription: "A função padrão é aplicada localmente quando esta conexão é selecionada.",
    saveAccess: "Salvar acesso",
    saveAutomation: "Salvar automação",
    copyDiagnostics: "Copiar diagnósticos",
    copyQuality: "Copiar qualidade",
    copyBundle: "Copiar pacote",
    copyAudit: "Copiar auditoria",
    copyPlugins: "Copiar plugins",
    changeArtifact: "Artefato de alteração",
    approval: "aprovação",
    ready: "pronto",
    copyMigration: "Copiar migração",
    copyRollback: "Copiar rollback",
    auditLog: "Log de auditoria",
    noAuditRecords: "Ainda não há registros de auditoria",
    clearAudit: "Limpar auditoria",
    pluginReadiness: "Prontidão de plugins",
    noPluginIssues: "Nenhum problema de publicação de plugin",
    recentAuditRecords: "Registros recentes de auditoria",
    auditEmptyHint: "O SQL executado aparecerá aqui após a consulta terminar.",
    dataQualityFindings: "Achados de qualidade de dados",
    qualityEmptyHint: "Execute uma consulta com valores nulos ou duplicados para ver achados.",
    automationDrafts: "Rascunhos de automação",
    automationEmptyHint: "Salve o SQL ativo como rascunho de automação para revisá-lo aqui.",
    notConfigured: "não configurado",
    noActiveSql: "sem SQL ativo",
    rollbackRequired: "rollback necessário",
    noRollbackRequired: "rollback não necessário",
    healthy: "saudável",
    pluginManifestsValid: "manifestos de plugins válidos",
    dryRun: "dry-run",
    direct: "direto",
    policyReady: "política pronta",
    manualScheduleReady: "agendamento manual pronto",
    noResult: "sem resultado",
    runQueryToProfile: "execute uma consulta para perfilar resultados",
    ...
    metric: {
      ...
      checks: "{count} verificações",
      publishable: "{publishable}/{total} publicáveis",
      drafts: "{count} rascunhos",
      rows: "{count} linhas",
      nullRate: "{name}: {rate}% nulos",
      blocked: "{count} bloqueados",
      pluginInstalled: "{publishable} publicáveis / {total} instalados",
    },
    reason: {
      connection_not_granted: "conexão não autorizada",
      sql_policy_blocked: "SQL bloqueado pela política",
      dangerous_sql_requires_approval: "SQL perigoso requer aprovação",
      write_permission_required: "permissão de escrita necessária",
      dangerous_sql_disabled: "SQL perigoso desativado",
      production_write_requires_approval: "escrita em produção requer aprovação",
      workspace_write_approval_required: "o workspace requer aprovação de escrita",
      ai_auto_execute_disabled: "execução automática por IA desativada",
      ai_writes_disabled: "escritas por IA desativadas",
      ai_write_dry_run_required: "escrita por IA requer dry-run",
      connection_required: "conexão necessária",
      schedule_required: "agendamento necessário",
      sql_required: "SQL necessário",
      target_required: "destino necessário",
      unsafe_sql: "SQL inseguro",
      production_write_automation: "automação de escrita em produção",
    },
    toast: {
      ...
      automationNoSql: "O rascunho não tem SQL executável",
      migrationCopied: "SQL de migração copiado",
      rollbackCopied: "Modelo de rollback copiado",
      auditSqlCopied: "SQL de auditoria copiado",
      auditReportCopied: "Relatório de auditoria copiado",
      auditCleared: "Registros de auditoria limpos",
      diagnosticsCopied: "Diagnósticos copiados",
      runQueryBeforeQuality: "Execute uma consulta antes de copiar o relatório de qualidade",
      qualityCopied: "Relatório de qualidade copiado",
      pluginReportCopied: "Relatório de plugins copiado",
      bundleCopied: "Pacote de governança copiado",
    },
  },
  databaseExport: {
