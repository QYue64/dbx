...
export default withEnglishFallback({
  ...
  automationCenter: {
    ...
    importMerge: "マージ",
    importReplace: "置換",
    fromCurrentSqlShort: "現在のSQL",
    useTemplate: "テンプレートを使用",
    scheduleWeekly: "毎週",
    scheduleMonthly: "毎月",
    weeklyDays: "曜日 (0=日, 1=月)",
    weekday: {
      0: "日",
      1: "月",
      2: "火",
    ...
    monthlyDay: "毎月の日付",
    choosePath: "パスを選択",
    webDavPasswordPlaceholder: "テストまたは安全なストレージへの保存に使用",
    webDavPasswordChecking: "パスワードを確認中",
    webDavPasswordSavedStatus: "パスワード保存済み",
    webDavPasswordNotSaved: "パスワード未保存",
    testWebDav: "接続をテスト",
    saveWebDavPassword: "パスワードを保存",
    forgetWebDavPassword: "保存済みパスワードを削除",
    bundleActions: "インポート / エクスポート",
    running: "実行中",
    dataCompareHint: "まずプレビューし、生成SQLを確認してから実行してください。",
    quickFix: "修正",
    copyRunDetails: "詳細をコピー",
    moreActions: "その他の操作",
    historyAll: "すべて",
    historySuccess: "成功",
    historyError: "エラー",
    clearCurrentHistory: "現在をクリア",
    clearAllHistory: "すべてクリア",
    syncExecutionMode: "同期実行",
    syncExecutionModeOption: {
      execute: "同期SQLを実行",
      preview: "プレビューのみ",
    },
    toast: {
      imported: "自動化をインポートしました",
      exported: "自動化をエクスポートしました",
      importFailed: "インポートに失敗しました: {message}",
      exportFailed: "エクスポートに失敗しました: {message}",
      pathSelectFailed: "パスの選択に失敗しました: {message}",
      historyCleared: "実行履歴をクリアしました",
      webdavTestSuccess: "WebDAV接続テストに成功しました",
      webdavTestFailed: "WebDAVテストに失敗しました: {message}",
      webdavPasswordRequired: "先にWebDAVパスワードを入力してください",
      webdavPasswordSaved: "WebDAVパスワードを安全なストレージに保存しました",
      webdavPasswordFailed: "WebDAVパスワードの保存に失敗しました: {message}",
      webdavPasswordForgotten: "保存済みWebDAVパスワードを削除しました",
      copied: "コピーしました",
    },
  },
  updates: {
    ...
    rateLimited: "GitHubのアップデート確認が一時的に制限されています。後で自動更新を再試行するか、リリースページで手動確認してください。",
    openRelease: "リリースページを開く",
    retryAutoUpdate: "自動更新を再試行",
    downloadAndInstall: "自動更新",
    downloadPortableZip: "ポータブルZIPをダウンロード",
    portableManualUpdate: "ポータブル版は実行中のアプリを直接置き換えられません。DBX が新しいポータブル ZIP をダウンロードします。完了後に DBX を閉じ、現在のフォルダへ上書き展開してください。portable.dbx とデータは保持されます。",
    portableDownloadSaved: "ポータブル ZIP をダウンロードしました: {path}",
    downloadingPortableZip: "ポータブル ZIP をダウンロード中...",
  ...
  settings: {
    ...
    syncWebDavDescription: "WebDAVを使って、接続メタデータ、サイドバー、保存済みSQL、デスクトップ設定、エディター設定をデバイス間で同期します。",
    ...
    syncSecretNotice: "デフォルトでは、DBXは機密性のない設定のみを同期します。データベースパスワード、SSHパスワード、プロキシパスワード、接続文字列、AI APIキーは、暗号化同期を有効にしない限りローカルに保持されます。",
    ...
    syncAutoUploadDescription: "DBXを開いている間だけ実行されます。ローカルの接続、保存済みSQL、UI設定を誤って置き換えないよう、ダウンロードは手動確認が必要です。",
    ...
    syncDownloadConfirm: "リモートDBXスナップショットをダウンロードして適用しますか？ローカルの接続メタデータ、サイドバー、保存済みSQL、デスクトップ設定、エディター設定が置き換えられます。",
    apply: "適用",
  ...
  governanceCenter: {
    title: "ガバナンスセンター",
    localRole: "ローカルロール",
    approveWrites: "書き込み承認",
    productionWrites: "本番書き込み",
    dangerousSql: "危険な SQL",
    aiWrites: "AI 書き込み",
    aiDryRun: "AI dry-run",
    savePolicy: "ポリシーを保存",
    activeConnectionAccess: "現在の接続アクセス",
    noActiveConnection: "現在の接続なし",
    connectionAccessDescription: "この接続を選択したとき、既定ロールをローカルに適用します。",
    saveAccess: "アクセスを保存",
    saveAutomation: "自動化を保存",
    copyDiagnostics: "診断をコピー",
    copyQuality: "品質をコピー",
    copyBundle: "ガバナンス一式をコピー",
    copyAudit: "監査をコピー",
    copyPlugins: "プラグインをコピー",
    changeArtifact: "変更成果物",
    approval: "承認",
    ready: "準備完了",
    copyMigration: "マイグレーションをコピー",
    copyRollback: "ロールバックをコピー",
    auditLog: "監査ログ",
    noAuditRecords: "監査記録はまだありません",
    clearAudit: "監査をクリア",
    pluginReadiness: "プラグイン公開準備",
    noPluginIssues: "プラグイン公開の問題はありません",
    recentAuditRecords: "最近の監査記録",
    auditEmptyHint: "SQL 実行後にここへ表示されます。",
    dataQualityFindings: "データ品質の検出",
    qualityEmptyHint: "NULL または重複値を含むクエリを実行すると検出結果が表示されます。",
    automationDrafts: "自動化ドラフト",
    automationEmptyHint: "現在の SQL を自動化ドラフトとして保存するとここで確認できます。",
    notConfigured: "未設定",
    noActiveSql: "現在の SQL なし",
    rollbackRequired: "ロールバックが必要",
    noRollbackRequired: "ロールバック不要",
    healthy: "正常",
    pluginManifestsValid: "プラグインマニフェストは有効です",
    dryRun: "dry-run",
    direct: "直接",
    policyReady: "ポリシー準備完了",
    manualScheduleReady: "手動スケジュール準備完了",
    noResult: "結果なし",
    runQueryToProfile: "クエリを実行して結果を分析",
    qualityFinding: "NULL {nulls} ({rate}%) · 重複 {duplicates} · 一意 {distinct}",
    section: {
      access: "アクセス",
      audit: "監査",
      change: "変更",
    ...
    metric: {
      records: "{count} 件",
      checks: "{count} チェック",
      publishable: "{publishable}/{total} 公開可能",
      drafts: "{count} ドラフト",
      rows: "{count} 行",
      nullRate: "{name}: NULL {rate}%",
      blocked: "{count} ブロック",
      pluginInstalled: "{publishable} 公開可能 / {total} インストール済み",
    },
    reason: {
      connection_not_granted: "接続が許可されていません",
      sql_policy_blocked: "SQL はポリシーでブロックされました",
      dangerous_sql_requires_approval: "危険な SQL には承認が必要です",
      write_permission_required: "書き込み権限が必要です",
      dangerous_sql_disabled: "危険な SQL は無効です",
      production_write_requires_approval: "本番書き込みには承認が必要です",
      workspace_write_approval_required: "ワークスペースで書き込み承認が必要です",
      ai_auto_execute_disabled: "AI 自動実行は無効です",
      ai_writes_disabled: "AI 書き込みは無効です",
      ai_write_dry_run_required: "AI 書き込みには dry-run が必要です",
      connection_required: "接続が必要です",
      schedule_required: "スケジュールが必要です",
      sql_required: "SQL が必要です",
      target_required: "ターゲットが必要です",
      unsafe_sql: "安全でない SQL",
      production_write_automation: "本番書き込み自動化",
    },
    toast: {
      ...
      automationNoSql: "自動化ドラフトに実行可能な SQL がありません",
      migrationCopied: "マイグレーション SQL をコピーしました",
      rollbackCopied: "ロールバックテンプレートをコピーしました",
      auditSqlCopied: "監査 SQL をコピーしました",
      auditReportCopied: "監査レポートをコピーしました",
      auditCleared: "監査記録をクリアしました",
      diagnosticsCopied: "診断をコピーしました",
      runQueryBeforeQuality: "品質レポートをコピーする前にクエリを実行してください",
      qualityCopied: "品質レポートをコピーしました",
      pluginReportCopied: "プラグインレポートをコピーしました",
      bundleCopied: "ガバナンス一式をコピーしました",
    },
  },
  databaseExport: {
    runInBackground: "バックグラウンドで実行",
