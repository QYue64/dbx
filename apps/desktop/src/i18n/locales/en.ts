export default {
  ...
  automationCenter: {
    ...
    fromCurrentSql: "From current SQL",
    fromCurrentSqlShort: "Current SQL",
    currentSqlJobName: "Current SQL automation",
    templateTitle: "Quick templates",
    templateHint: "Choose a task first, then fill required fields",
    ...
    weeklyDays: "Weekdays (0=Sun, 1=Mon)",
    weekday: {
      0: "Sun",
      1: "Mon",
      2: "Tue",
    ...
    table: "Table",
    syncMode: "Sync mode",
    syncExecutionMode: "Sync execution",
    webDavConfig: "WebDAV config JSON",
    webDavEndpoint: "WebDAV endpoint",
    webDavUsername: "Username",
    webDavRemotePath: "Remote path",
    webDavPasswordPlaceholder: "Enter to test or save in secure storage",
    webDavPasswordChecking: "Checking password",
    webDavPasswordSavedStatus: "Password saved",
    webDavPasswordNotSaved: "Password not saved",
    testWebDav: "Test connection",
    saveWebDavPassword: "Save password",
    forgetWebDavPassword: "Forget saved password",
    ...
    bundleActions: "Import / export",
    payloadJsonHint: "Structured fields sync here automatically; edit JSON only for bulk changes or debugging.",
    nextRun: "Next run",
    lastRun: "Last run",
    scheduleReadable: "Schedule",
    ...
    syncStatements: "{count} sync SQL",
    ready: "Ready",
    qualityNoFindings: "No obvious quality findings",
    dataCompareHint: "Preview first; execute after reviewing the generated SQL.",
    quickFix: "Fix",
    copyRunDetails: "Copy details",
    ...
    historyError: "Error",
    clearCurrentHistory: "Clear current",
    clearAllHistory: "Clear all",
    qualityRows: "{count} rows profiled",
    kind: {
      sql: "SQL",
      export: "Export",
      sync: "Sync",
    ...
    template: {
      "current-sql": {
        name: "Run current SQL",
        description: "Use the active editor SQL, connection, and database for quick scheduling.",
      },
      "daily-export": {
        name: "Daily query export",
        description: "Export query results to a local file at a fixed time every day.",
      },
      "quality-check": {
        name: "Quality check",
        description: "Run SQL and summarize nulls, duplicates, and other data quality signals.",
      },
      "webdav-upload": {
        name: "WebDAV config upload",
        description: "Upload current configuration to a WebDAV folder on a schedule.",
      },
      "saved-sql-directory": {
        name: "Sync SQL library directory",
        description: "Export the SQL library to a local directory for backup or versioning.",
      },
      "data-compare-preview": {
        name: "Data sync preview",
        description: "Generate sync SQL first; switch to execute only after reviewing risk.",
      },
    },
    scheduleSummary: {
      manual: "Manual run",
      interval: "Every {count} minutes",
      daily: "Daily at {time}",
    ...
    syncModeOption: {
      ...
      "saved-sql-directory": "SQL library directory",
      "data-compare": "Database data sync",
    },
    syncExecutionModeOption: {
      execute: "Execute sync SQL",
    ...
    reason: {
      ...
      source_connection_not_found: "Source connection not found",
      target_connection_not_found: "Target connection not found",
      sql_required: "SQL required",
      path_required: "Path required",
      sync_mode_required: "Sync mode required",
      unsafe_sql: "Unsafe SQL",
      production_write_automation: "Production write blocked",
      export_mode_invalid: "Invalid export mode",
      format_invalid: "Export format is not valid for this mode",
      schedule_invalid: "Invalid schedule",
      sync_execution_mode_invalid: "Invalid sync execution mode",
      table_required: "Table required",
      webdav_config_required: "WebDAV config required",
      webdav_endpoint_required: "WebDAV endpoint required",
      target_required: "Target required",
      columns_required: "Columns required",
      key_columns_required: "Key columns required",
    },
    reasonFix: {
      default: "Check the matching required field or advanced config.",
      connection_required: "Select a connection.",
      connection_not_found: "Select an existing connection again.",
      source_connection_not_found: "Select a valid source connection for data sync.",
      target_connection_not_found: "Select a valid target connection for data sync.",
      sql_required: "Enter SQL, or create the job from the current SQL editor.",
      path_required: "Choose an export file path.",
      sync_mode_required: "Choose a sync mode.",
      unsafe_sql: "Edit the SQL or allow the risk in governance policy.",
      production_write_automation: "Switch to preview, choose a non-production connection, or adjust governance policy.",
      export_mode_invalid: "Choose a valid export mode.",
      format_invalid: "Choose a format supported by the current export mode.",
      schedule_invalid: "Check interval, time, weekdays, or monthly day.",
      sync_execution_mode_invalid: "Choose execute or preview.",
      table_required: "Enter the table to export.",
      webdav_config_required: "Fill WebDAV endpoint, username, and remote path.",
      webdav_endpoint_required: "Fill the WebDAV endpoint.",
      target_required: "Choose the target directory.",
      columns_required: "Enter columns to sync.",
      key_columns_required: "Enter key columns used to match rows.",
    },
    toast: {
      saved: "Automation saved",
      imported: "Automation imported",
      exported: "Automation exported",
      importFailed: "Import failed: {message}",
      exportFailed: "Export failed: {message}",
      pathSelectFailed: "Path selection failed: {message}",
      historyCleared: "Run history cleared",
      webdavTestSuccess: "WebDAV connection test passed",
      webdavTestFailed: "WebDAV test failed: {message}",
      webdavPasswordRequired: "Enter a WebDAV password first",
      webdavPasswordSaved: "WebDAV password saved to secure storage",
      webdavPasswordFailed: "Failed to save WebDAV password: {message}",
      webdavPasswordForgotten: "Saved WebDAV password removed",
      copied: "Copied",
      fixPayload: "Fix payload JSON first",
      fixPlan: "Fix risk check issues before enabling",
      fixRunPlan: "Fix risk check issues before running",
      runSuccess: "Automation finished",
      runSuccessNamed: "{name} finished",
      runFailed: "{name} failed: {message}",
    },
    notify: {
      failure: "On failure",
      always: "Always",
  ...
  updates: {
    ...
    rateLimited: "GitHub update checks are temporarily rate limited. Try automatic update again later, or open the release page to check manually.",
    openRelease: "Open Release",
    retryAutoUpdate: "Retry automatic update",
    downloadAndInstall: "Auto update",
    downloadPortableZip: "Download portable ZIP",
    portableManualUpdate: "Portable builds cannot replace the running app in place. DBX will download the new portable ZIP; after it finishes, close DBX and extract it over the current DBX folder to keep portable.dbx and data.",
    portableDownloadSaved: "Portable ZIP downloaded to: {path}",
    downloadingPortableZip: "Downloading portable ZIP...",
  ...
  settings: {
    ...
    syncWebDavDescription: "Sync connection metadata, sidebar layout, saved SQL, desktop settings, and editor preferences across devices through WebDAV.",
    ...
    syncSecretNotice: "By default, DBX syncs non-sensitive configuration only. Database passwords, SSH passwords, proxy passwords, connection strings, and AI API keys stay local unless encrypted sync is enabled.",
    ...
    syncAutoUploadDescription: "Runs while DBX is open. Downloads still require manual confirmation to avoid replacing local connections, saved SQL, and UI preferences unexpectedly.",
    ...
    syncDownloadConfirm: "Download and apply the remote DBX snapshot? Local connection metadata, sidebar layout, saved SQL, desktop settings, and editor preferences will be replaced.",
    apply: "Apply",
  ...
  governanceCenter: {
    ...
    activeConnectionAccess: "Active connection access",
    noActiveConnection: "No active connection",
    connectionAccessDescription: "Default role applies locally when this connection is selected.",
    ...
    approval: "approval",
    ready: "ready",
    copyMigration: "Copy migration",
    copyRollback: "Copy rollback",
    auditLog: "Audit log",
    noAuditRecords: "No audit records yet",
    clearAudit: "Clear audit",
    pluginReadiness: "Plugin readiness",
    noPluginIssues: "No plugin publish issues",
    recentAuditRecords: "Recent audit records",
    auditEmptyHint: "Executed SQL will appear here after a query finishes.",
    dataQualityFindings: "Data quality findings",
    qualityEmptyHint: "Run a query with nullable or duplicate values to see findings.",
    automationDrafts: "Automation drafts",
    automationEmptyHint: "Save the active SQL as an automation draft to review it here.",
    notConfigured: "not configured",
    noActiveSql: "no active SQL",
    rollbackRequired: "rollback required",
    noRollbackRequired: "no rollback required",
    healthy: "healthy",
    pluginManifestsValid: "plugin manifests valid",
    dryRun: "dry-run",
    direct: "direct",
    policyReady: "policy ready",
    manualScheduleReady: "manual schedule ready",
    noResult: "no result",
    runQueryToProfile: "run a query to profile results",
    qualityFinding: "nulls {nulls} ({rate}%) · duplicates {duplicates} · distinct {distinct}",
    section: {
      access: "Access",
      audit: "Audit",
      change: "Change",
    ...
    metric: {
      ...
      checks: "{count} checks",
      publishable: "{publishable}/{total} publishable",
      drafts: "{count} drafts",
      rows: "{count} rows",
      nullRate: "{name}: {rate}% null",
      blocked: "{count} blocked",
      pluginInstalled: "{publishable} publishable / {total} installed",
    },
    reason: {
      connection_not_granted: "connection not granted",
      sql_policy_blocked: "SQL blocked by policy",
      dangerous_sql_requires_approval: "dangerous SQL requires approval",
      write_permission_required: "write permission required",
      dangerous_sql_disabled: "dangerous SQL disabled",
      production_write_requires_approval: "production write requires approval",
      workspace_write_approval_required: "workspace write approval required",
      ai_auto_execute_disabled: "AI auto execute disabled",
      ai_writes_disabled: "AI writes disabled",
      ai_write_dry_run_required: "AI write dry-run required",
      connection_required: "connection required",
      schedule_required: "schedule required",
      sql_required: "SQL required",
      target_required: "target required",
      unsafe_sql: "unsafe SQL",
      production_write_automation: "production write automation",
    },
    toast: {
      ...
      automationNoSql: "Automation draft has no executable SQL",
      migrationCopied: "Migration SQL copied",
      rollbackCopied: "Rollback template copied",
      auditSqlCopied: "Audit SQL copied",
      auditReportCopied: "Audit report copied",
      auditCleared: "Audit records cleared",
      diagnosticsCopied: "Diagnostics copied",
      runQueryBeforeQuality: "Run a query before copying a quality report",
      qualityCopied: "Quality report copied",
      pluginReportCopied: "Plugin report copied",
      bundleCopied: "Governance bundle copied",
    },
  },
  databaseExport: {
